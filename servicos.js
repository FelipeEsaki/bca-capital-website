const servicos = [
    ...
    },
    {
        ...
        servico: 'Seguros',
        texto: `A BCA Capital possui <strong>todos os tipos de seguros</strong> e <strong>mais de 10 seguradoras</strong> parceiras para melhor atender sua necessidade!`
    },
    {
        imagem: `assets/servicos/consorcio.jpg`,
        servico: 'Consórcios',
        texto: `A BCA Capital oferece a <strong>melhor opção de consórcio</strong> de acordo com sua necessidade. Trabalhamos com todos os tipos de consórcios!`
    },
    // {
    ...
    },
    {
        ...
        texto: `Está na hora de adquirir seu <strong>novo veículo</strong>! Com a BCA Capital você tem as <strong>melhores taxas</strong> e opções de financiamento!`
    },
    {
        imagem: `assets/servicos/casa.jpg`,
        servico: 'Financiamento Residencial',
        texto: `Está na hora de adquirir sua <strong>nova casa</strong>! Com a BCA Capital você tem as <strong>melhores taxas</strong> e opções de financiamento, refinanciamento e carta fiança!`
    },
    // {
    //     imagem: `assets/servicos/conta.jpg`,
    //     servico: 'Abertura de conta',
    //     texto: `Abra sua conta bancária <strong>sem custo</strong>! Com a BCA Capital você tem os <strong>melhores bancos</strong> para abrir sua conta bancária digital!`
    // },
    // {
    ...
    //     texto: `A BCA Capital oferece <strong>diversas opções de maquininha de cartão</strong> com as <strong>melhores taxas</strong> do mercado! `
    // },
];
